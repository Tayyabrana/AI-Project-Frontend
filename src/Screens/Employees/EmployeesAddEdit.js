...
const EmployeesAddEdit = ({ edit = false }) => {
  ...
  return (
    <div className="bg-white rounded-xl w-full h-full min-h-[calc(100vh-120px)] shadow-xl">
      {loading === true ? (
        <Loading />
      ) : (
        <>
          <div className="lg:w-[90%] w-full mx-auto bg-white rounded-xl px-12 pt-10 pb-8 flex flex-col my-5">
            <h1 className="text-center text-[25px] font-[500] text-primary uppercase">
              Add Employee
            </h1>
            <hr className=" mb-8" />
            ...
            <div className="flex justify-center">
              <button
                onClick={() => submit()}
                className="bg-black hover:font-bold text-white font-[600] py-2 px-[3rem] mt-4
